...
var cp = require('child_process'); // make a variable based ont the system
...
function jekyll(done) {
  var jekyll = process.platform === "win32" ? "jekyll.bat" : "jekyll"; // Use that sukka cp(jekyll, ['build'], {stdio: 'inherit'});
